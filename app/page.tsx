            ...
            <div className="lg:col-span-3 space-y-6 sm:space-y-8">
              <div className="space-y-3 sm:space-y-2">
                ...
                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-light tracking-tight">
                  Gotis
                  <br />
                  <span className="text-muted-foreground">Chardie</span>
                </h1>
              </div>

              <div className="space-y-6 max-w-md">
                <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
                  Computer Science Senior & Frontend Developer | Building
                  user-centric
                  <span className="text-foreground"> web applications</span>,
                  and digital solutions that bridge the gap between
                  <span className="text-foreground"> Design</span>, and
                  <span className="text-foreground"> Technical logic</span>.
                </p>
