                ...
                <div ref={gridFullRef} className="grid--full relative w-full my-[10vh] h-auto aspect-[1.1] max-w-none p-4 grid gap-4 grid-cols-7 grid-rows-5">
                    ...
                    {mixedGridItems.map((item, i) => {
                                    ...
                                    {bentoItems.map((bentoItem, index) => {
                                        ...
                                        return (
                                            <div
                                                ...
                                                onClick={() => {
                                                    if (isActive && bentoItem.url) {
                                                        window.open(bentoItem.url, '_blank', 'noopener,noreferrer')
                                                    } else {
                                            ...
                                            >
                                                ...
                                                <div className={cn(
                                                    ...
                                                    <div className="text-white/50 transition-colors">
                                                        {bentoItem.icon}
                                                    </div>
                        ...
                        if (typeof item === 'string') {
                            const Icon = i % 3 === 0 ? FaGithub : i % 3 === 1 ? FaLinkedin : MdEmail
                            const label = i % 3 === 0 ? "GitHub" : i % 3 === 1 ? "LinkedIn" : "Email"
