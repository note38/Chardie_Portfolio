...
const DEFAULT_PROJECTS: Project[] = [
  ...
  },
  {
   ...
   {
    id: "6",
    title: "Renaming PDF Files",
    description: "DICT Renaming PDF Files using n8n, a Workflow that automates the process of renaming PDF files based on specific criteria or metadata.",
    techStack: "n8n",
    githubUrl: "https://github.com/note38/Renaming-PDF-Files",
  },
   {
    id: "7",
    title: "Sending Certificates",
    description: "DICT Sending Certificates System, a Workflow that streamlines the process of sending and managing certificates for various events and achievements.",
    techStack: "n8n",
    githubUrl: "https://github.com/note38/Sending-Certificates",
  },
  {
    id: "5",
    title: "Jewel-kate",
